# Registration of Google Cloud projects for [Google Earth Engine (GEE)](https://code.earthengine.google.com/)
...
To see these instructions as a set ofslides, see: https://bit.ly/gee_project_reg.
